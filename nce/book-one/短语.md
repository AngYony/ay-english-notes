...
play with a ball（球） / doll（娃娃） / toy（玩具）
...
another如果直接接名词的话，那么这个名词一定要是可数名词单数形式。

示例：Here is another photograph.（这是另外一张照片）

another + 数词 + 名词（可以是复数）

如果another和名词之间加了数词结构，那么这个名词可以使用复数的形式，也可以使用单数的形式。

示例：I need another two hammers.（我需要另外两个锤子）



## 年龄的表达

两种表达方式，一种是用years old，另一种是使用连接符“-”：
...
nineteen years old，或者 nineteen year-old
